      ...
      sections: [
        {
          ...
          callout: "Understand the purpose and constraints before beginning practical work."
        },
        {
          ...
          callout: "Permission applies to the person, the machine, the setup and the task."
        },
        {
          ...
          callout: "Safe practical work begins before the tool is switched on."
        }
      ],
      checks: [
      ...
      sections: [
        {
          ...
          callout: "Plan, measure, mark and check before any cutting begins."
        },
        {
          ...
          callout: "A sketch explores; an approved working drawing controls production."
        },
        {
          ...
          callout: "A clear mark is only useful when it is in the correct place."
        }
      ],
      checks: [
      ...
      sections: [
        {
          ...
          callout: "Secure the work first, then use the approved tool and setup."
        },
        {
          ...
          callout: "A cut is not complete until the edge is safe for the next stage."
        },
        {
          ...
          callout: "The right sequence protects the accuracy created during marking-out."
        }
      ],
      checks: [
      ...
      sections: [
        {
          ...
          callout: "Check the fit first, join safely, then prepare and protect the surface."
        },
        {
          ...
          callout: "The joint must suit the design, load and classroom process."
        },
        {
          ...
          callout: "A finish cannot hide poor preparation; it usually reveals it."
        }
      ],
      checks: [
      ...
      sections: [
        {
          ...
          callout: "Good evidence connects the stage, decision, check and result."
        },
        {
          ...
          callout: "A folio is an evidence trail, not a photo dump."
        },
        {
          ...
          callout: "Specific evidence turns an opinion into an evaluation."
        }
      ],
      checks: [
